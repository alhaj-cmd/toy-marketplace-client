            ...
            <div className="carousel my-6 w-full">
                <div id="slide1" className="carousel-item  relative w-full">
                    ...
                    <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
                        ...
                        <div className='text-gray-300 bg-opacity-60 font-bold'>
                            <h1 className="mb-5 text-2xl ">Hello <span className='text-6xl text-orange-500'>Science Kits</span></h1>
                ...
                <div id="slide2" className="carousel-item relative w-full">
                    ...
                    <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
                        ...
                        <div className='text-gray-300 bg-opacity-60 font-bold'>
                            <h1 className="mb-5 text-2xl ">Hello <span className='text-6xl text-orange-500'>math learning toys</span></h1>
                            <p>Find Every Think for your Educational and Learning Toys</p>
                            <button></button>
                        </div>
                ...
                <div id="slide3" className="carousel-item relative w-full">
                    ...
                    <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
                        <a href="#slide2" className="btn btn-circle">❮</a>
                        <div className='text-gray-300 bg-opacity-60 font-bold'>
                            <h1 className="mb-5 text-2xl ">Hello <span className='text-6xl text-orange-500'>engineering kits</span></h1>
                            <p>Find Every Think for your Educational and Learning Toys</p>
                            <button></button>
                        </div>
                        <a href="#slide4" className="btn btn-circle">❯</a>
